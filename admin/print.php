...
header h1 { background: #0f2453; border-radius: 0.25em; color: #ffce14; margin: 0 0 1em; padding: 0.5em 0; }
...
@page {
	...
	<div class="back-button-container">
        <a href="payment.php" class="back"><span>Back</span></a>
    </div>
	...
	?>
		<header>
			...
			<span><img alt="" src="images/hypnos.jpg"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
